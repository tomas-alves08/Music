    ...
    <section class="w-full mb-8 py-14 text-center text-white relative">
      ...
      <div class="container mx-auto flex items-center">
        ...
        <div class="z-50 text-left ml-8">
          ...
          <div>{{ song.genre }}</div>
          <div class="song-price">{{ $n(7.99, 'currency', 'ja') }}</div>
        </div>
      </div>
    </section>
    <!-- Form -->
...
export default {
  ...
  methods: {
    ...
    async addComment(values, { resetForm }) {
      ...
      this.comment_alert_message = 'Please wait! Your message is being submitted'
      ...
      this.comment_alert_message = 'Comment added succesfully!'
